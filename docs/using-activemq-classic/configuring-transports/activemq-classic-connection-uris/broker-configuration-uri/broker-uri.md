...
populateJMSXUserID|false|Should the broker populate the [JMSXUserID](../../../../features/jmsxuserid) property of messages to indicate the authenticated sender username who sent the message
