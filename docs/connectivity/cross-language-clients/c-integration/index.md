...
*   we are working on the [OpenWire CPP Client](../activemq-c-clients/openwire-cpp-client)
...
*   use the [REST](../../protocols/rest) API
*   use [WS-Notification](http://servicemix.org/WS+Notification) and generate C bindings to WS-Notification using a SOAP stack
*   use [.Net or Mono](../../../overview/faq/using-apache-activemq-classic/how-do-i-access-activemq-classic-from-csharp-or-dotnet) to use ActiveMQ Classic insided .Net
...
*   Use a Jabber client to talk to the ActiveMQ Classic broker via the [XMPP](../../protocols/xmpp) protocol
