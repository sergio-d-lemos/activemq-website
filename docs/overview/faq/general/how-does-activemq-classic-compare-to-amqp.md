...
 [FAQ](..) > [General](.) > [How does ActiveMQ Classic compare to AMQP](how-does-activemq-classic-compare-to-amqp)
...
*   [OpenWire](../../../connectivity/protocols/openwire), a fast binary format
*   [Stomp](../../../connectivity/protocols/stomp), a simple and easily implemented text based-protocol
*   [MQTT](../../../connectivity/protocols/mqtt), a compact binary format for limited devices on an unreliable network
