...
 [FAQ](..) > [General](.) > [How does ActiveMQ Classic compare to Spread Toolkit](how-does-activemq-classic-compare-to-spread-toolkit)
...
Apache ActiveMQ Classic on the other hand is the JMS provider used in [Apache Geronimo](http://geronimo.apache.org) and is J2EE 1.4 certified in Geronimo and is 100% pure Java. ActiveMQ Classic supports transient and durable messaging, transactions, XA, J2EE 1.4, JMS 1.1, JCA 1.5 as well as heaps of different features like [Message Groups](../../../features/consumer-features/message-groups) and [Clustering](../../../features/clustering)
