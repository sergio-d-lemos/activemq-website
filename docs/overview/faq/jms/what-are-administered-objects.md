...
 [FAQ](..) > [JMS](.) > [What are administered objects](what-are-administered-objects)


What are administered objects?
------------------------------

Administered objects refers to objects that are configured in [JNDI](../../../connectivity/containers/jndi-support) and then accessed by a JMS client. So they are simply client-side objects typically either a ConnectionFactory or a Destination (such as a Queue or Topic).
...
An alternative approach to creating administered objects in JNDI is to just use the [Spring Support](../../../connectivity/containers/spring-support) and let dependency injection be an alternative to JNDI.

### See Also

*   [How do I create new destinations](../using-apache-activemq-classic/how-do-i-create-new-destinations)
