...
 [FAQ](..) > [Errors](.) > [I do not receive messages in my second consumer](i-do-not-receive-messages-in-my-second-consumer)
...
This is to do with [prefetch buffers](../../../features/what-is-the-prefetch-limit-for).
...
You can also [change the dispatch policy](../using-apache-activemq-classic/how-do-i-change-dispatch-policy) to ensure round robin dispatch.

To help diagnose these kinds of issues, try [JMX](../../../features/jmx) or the [Web Console](../../../tools/web-console)

### See also

*   [How do I change dispatch policy](../using-apache-activemq-classic/how-do-i-change-dispatch-policy)
*   [JMX](../../../features/jmx)
