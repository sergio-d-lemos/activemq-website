...
<destinationPolicy>
  <policyMap>
    <policyEntries>
      ...
      ...
```
The full range of priority values (0-9) are supported by the [JDBC](../../../features/persistence/jdbc-support) message store. For [KahaDB](../../../kahadb) three priority categories are supported, Low (< 4), Default (= 4) and High (> 4).
...
To do this use the [Resequencer](http://activemq.apache.org/camel/resequencer.html) from the [Enterprise Integration Patterns](../../../features/enterprise-integration-patterns)
