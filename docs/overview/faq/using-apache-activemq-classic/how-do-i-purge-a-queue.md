...
You can use the [Web Console](../../../tools/web-console) to view queues, add/remove queues, purge queues or delete/forward individual messages.

Another option is to use [JMX](../../../features/jmx) to browse the queues and call the **purge()** method on the [QueueViewMBean](http://activemq.apache.org/components/classic/documentation/maven/apidocs/org/apache/activemq/broker/jmx/QueueViewMBean.html).
