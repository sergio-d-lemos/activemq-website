...
However if you really want it to be very lightweight and fast, [enable async sending](../../../using-activemq-classic/configuring-transports) on your JMS connection.
