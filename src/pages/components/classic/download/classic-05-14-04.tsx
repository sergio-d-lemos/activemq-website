...
export default function Release() {
  return (
    <ClassicRelease
      version="5.14.4"
    >
      <div dangerouslySetInnerHTML={{__html: `Apache ActiveMQ Classic 5.14.4 includes several resolved[ issues](https://issues.apache.org/jira/secure/ReleaseNote.jspa?projectId=12311210&version=12338909) and bug fixes.
